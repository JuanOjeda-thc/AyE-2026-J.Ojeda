...
string[] nombres = { "electroencefalografista", "Mouse", "Teclado", "Componentes", "supercalifragilisticoespialidoso", "Programa", "Balatro", "Proyectos", "pneumonoultramicroscopicsilicovolcanoconiosis", "Geografia" };
